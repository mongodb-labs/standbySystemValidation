// Copied components from https://github.com/mongodb-js/mongodb-connection-string-url/blob/main/src/index.ts
// Converted to plain JS for mongosh compatibility (no npm, no imports).
...
class ConnectionString extends URL {
  constructor(uri, options = {}) {
    ...
    try {
      ...
      if (looseValidation) {
        new ConnectionString(uri, { ...options, looseValidation: false });
      }
